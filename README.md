...
회원별 PDF·PNG·JPEG 저장 코드와 실제 Storage 버킷 연결이 완료됐습니다. 로컬 3001 환경에서 업로드 기능을 활성화했습니다. 직접 확정한 운동 기록의 저장·집계가 연결됐습니다. Gemini 3.1 Flash-Lite 자동 판독과 원본 대조·확정 저장을 연결했습니다. AI 종합 분석은 다음 단계입니다.
