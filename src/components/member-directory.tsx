...
export function MemberDirectory({members,search,onSearch,onOpen,onCreate,canCreate,preferences,onPreferences,onEdit,onDelete,onUpload,online}:{onEdit:(member:Member)=>void;onDelete:(member:Member)=>void;onUpload:(member:Member)=>void;online:boolean;members:Member[];search:string;onSearch:(value:string)=>void;onOpen:(id:string)=>void;onCreate:()=>void;canCreate:boolean;preferences:DisplayPreferences;onPreferences:(patch:Partial<DisplayPreferences>)=>void}){
