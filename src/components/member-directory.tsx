...
export function MemberDirectory({members,search,onSearch,onOpen,onCreate,canCreate}:{members:Member[];search:string;onSearch:(value:string)=>void;onOpen:(id:string)=>void;onCreate:()=>void;canCreate:boolean}){
